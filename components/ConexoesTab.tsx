...
export const ConexoesTab: React.FC = () => {
  ...
  const ATIVIDADE_SHEET_URL = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vRTghosKUGfdajRIIBogZzdYcxh6G4Yrj6zIHojZFw8zHWoQiGAwz3VvNNr4zTiJWe3VeNOzFsE0dOT/pub?output=csv';
    ...
    <div className="space-y-6 animate-in fade-in duration-200">
      ...
      {activeTab === 'logs' && (
        <div className="bg-zinc-900/60 p-6 rounded-2xl border border-zinc-800/80 animate-in fade-in duration-200 space-y-5">
          ...
          {/* Logs de Parse — falhas de validacao do sheetsService */}
